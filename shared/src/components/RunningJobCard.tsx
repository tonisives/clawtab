      ...
      <View style={styles.row}>
        ...
        <View style={styles.info}>
          <View style={styles.titleRow}>
            <Text style={[styles.name, stopping && { opacity: 0.5 }]} numberOfLines={1}>{job.display_name ?? job.name}</Text><MachineBadge machineId={job.machine_id} compact={Platform.OS === "ios"} />
