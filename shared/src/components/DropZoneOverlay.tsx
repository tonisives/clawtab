...
import type { SplitDirection } from "./SplitDetailArea";
...
interface DropZoneOverlayProps {
  ...
  isSplit: boolean;
  /** Current split direction (only relevant when isSplit) */
  splitDirection?: SplitDirection;
  /** Ratio of split (only relevant when isSplit) */
  splitRatio?: number;
  /** Currently hovered zone (computed by parent from pointer coords) */
...
function ZoneIndicator({ zoneId, active, style }: { zoneId: DropZoneId; active: boolean; style: React.CSSProperties }) {
