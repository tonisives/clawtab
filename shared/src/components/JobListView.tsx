...
export function JobListView(props: JobListViewProps) {
  ...
  return <MachineOnboardingProvider content={props.machineOnboarding} management={props.machineManagement} chrome={props.machineChrome}><JobListViewComponent hook={hook} /></MachineOnboardingProvider>;
}
