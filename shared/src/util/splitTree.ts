...
export function splitLeaf(
  ...
  const replacement: SplitNode = {
    ...
    direction,
    ratio: 0.5,
    first: position === "before" ? newLeaf : { type: "leaf", id: leafId, content: findLeafContent(root, leafId)! },
    second: position === "after" ? newLeaf : { type: "leaf", id: leafId, content: findLeafContent(root, leafId)! },
  };
