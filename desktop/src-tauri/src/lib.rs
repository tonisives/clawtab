...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::claude_history::search_claude_history,
            ...
            commands::processes::list_installed_plugins,
            commands::processes::approve_plugin,
            commands::processes::revoke_plugin,
