...
pub fn get_jobs(state: State<AppState>) -> Vec<Job> {
    ...
    if config.agent_selection_migration_needed() {
...
fn clone_job_with_overrides(
    ...
    Job {
        ...
        run_once: source.run_once.clone(),
        ...
        agent_effort: source.agent_effort.clone(),
        added_at: Some(chrono::Utc::now().to_rfc3339()),
...
// generate_agent_cwt_context moved to crate::agent
