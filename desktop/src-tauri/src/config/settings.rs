...
pub struct ShortcutSettings {
    ...
    pub rename_active_pane: String,
    pub focus_agent_input: String,
    pub zoom_active_pane: String,
...
impl Default for ShortcutSettings {
    fn default() -> Self {
        Self {
            ...
            resize_pane_left: "Prefix Shift+Less".to_string(),
            resize_pane_right: "Prefix Shift+Greater".to_string(),
            resize_pane_up: "Prefix Shift+Plus".to_string(),
            resize_pane_down: "Prefix Minus".to_string(),
